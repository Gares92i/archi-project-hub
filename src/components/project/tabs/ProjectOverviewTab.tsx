...
import { FileText, Clock, Check, Plus, Calendar, MessageCircle, ListChecks } from "lucide-react";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import TaskList from "@/components/TaskList";
import { useNavigate } from "react-router-dom";
import { formatDate } from "@/utils/dateFormatters";
import { projectMilestones, teamMembers, projectTasks, projectDocuments, projectStats } from "@/data/projectDetailsData";

interface ProjectOverviewTabProps {
  projectId: string;
}

const ProjectOverviewTab = ({ projectId }: ProjectOverviewTabProps) => {
